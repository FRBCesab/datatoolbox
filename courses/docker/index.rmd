...
`r icon::fa("hand-point-right", color = "#3f3f3f")` &nbsp;
Si on se rappelle la définition d'un conteneur, celui contient un environnement
de travail mais aussi une application. Or, il nous manque l'application.

En plus on aime bien `r icon::fa("r-project")` !
...
- Docker-compose :
  ...
  - creer d'abird image Dockerfile
