...
- Divise une région en cellules (ou pixel)
...
```{r "ras1", echo=TRUE, eval=TRUE, fig.align='center'}
...
- [**Très bonne introduction d'Olivier**](https://oliviergimenez.github.io/intro_spatialR/#1)
