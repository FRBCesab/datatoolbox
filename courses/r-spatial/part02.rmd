...
(prefectures <- readr::read_csv(
  here::here("courses", "r-spatial", "assets", "data", "occitanie_prefectures.csv")
))
```
...
sf::st_layers(here::here("courses", "r-spatial", "assets", "data", "occitanie.shp"))
```
...
occitanie <- sf::st_read(
  dsn = here::here("courses", "r-spatial", "assets", "data"),
