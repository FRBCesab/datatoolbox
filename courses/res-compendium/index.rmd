...
- Écrivez des fonctions ! Placez les dans le répertoire R. 

- Numérotez les scripts d'analyses, placez-y des entêtes
...
<br />
<br />
.center[SI VOUS UTILISEZ LA FONCTION SETWD() JE BRÛLE VOTRE BABAS !]
...
Chaque script écrit des résultats (fichiers) les référençant explicitement dans leur nom. N'exportez que le nécessaire, ce qui à vocation à être partagé ou alors le résultat d'étapes longues.

.center[e.g. le script "R/01_ingest_data.R" écrit des résultats du type "res/01_Zzz9Zzz9.csvc"]
...
Placez un README à la racine du projet, exposez-y explictement les dépendances.

--> Vivez le miracle du fichier DESCRIPTION !
...
- github ou gitlab sont des solutions, mais limitées en capacité de stockage, et pas forcement perènes.
