...
subtitle: <i>the best part </i>&nbsp;`r fontawesome::fa_i("grin-tongue")`
...
`r fontawesome::fa_i("quote-left", class = "dark")` &nbsp;_In R, the fundamental unit of
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Make sure to select `R Package using devtools`

<br />

`r fontawesome::fa_i("exclamation-triangle", class = "dark")` &nbsp;A package name can **only contain** letters and numbers (the dot is the only non-alphanumeric character allowed)
...
- Using `r fontawesome::fa_i("r-project")` directly (no IDE)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Make sure to specify the `absolute path` to your package
...
## `r fontawesome::fa_i("exclamation-circle")` &nbsp;What about reproducibility?

--

- We will create an `r fontawesome::fa_i("r-project")` script with all the command lines required to develop our package so we can reuse it in the future for new developments.
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;From now, **all the command lines** will be written in this file.

--

<br />

`r fontawesome::fa_i("exclamation-triangle", class = "dark")` &nbsp;As this file is not part of a typical package structure, we need to tell R to ignore it when checking and installing the package. It's the purpose of the `.Rbuildignore` file.
...
- Let's initialize the `r fontawesome::fa_i("git")` versioning
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Commit changes and restart RStudio

---


## `r fontawesome::fa_i("apple")` .DS_Store files
...
`r fontawesome::fa_i("exclamation-triangle", class = "dark")` &nbsp;The other fields will be added/modified automatically.

--

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**R Package - Chap8**](https://r-pkgs.org/description.html)
...
`r fontawesome::fa_i("exclamation-triangle", class = "dark")` &nbsp;A dummy file has been created in `R/`: **do not edit this file!**
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**choosealicense.com**](https://choosealicense.com)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**Tidyverse style guide**](https://style.tidyverse.org/) and the R package `{styler}` (with its RStudio addin) to format your R code
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Before going any further we have to try our code. So we will load our package (and **NOT** sourcing the function)
...
`r fontawesome::fa_i("beer", class = "dark")`
`r fontawesome::fa_i("beer", class = "dark")`
`r fontawesome::fa_i("beer", class = "dark")`
&nbsp; **Yeah!!!** &nbsp;
`r fontawesome::fa_i("beer", class = "dark")`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Keywords `@title` and `@description` can be omitted
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;If your function has **parameters**, each one must be documented
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;If your function **returns** an R object use the keyword `@return`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add a section `@examples` to show how to use your function
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;You can also add a reproducible example (dataset added to your package)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Finally if you want your function to be used directly by user you need to add this tag
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Additional Roxygen2 tags
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**R Package - Chap10**](https://r-pkgs.org/man.html) and [**R Package Primer**](https://kbroman.org/pkg_primer/pages/docs.html)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;It's time to generate the corresponding `.Rd` file (special file for R documentation) from this Roxygen2 header
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;As we can see this file lists which functions need to be exported (accessible by the user when loading the package). But it also deals with external dependencies.
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;It's time to check the integrity of our package
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Finally we can install our package
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Package `{testthat}`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;A new `r fontawesome::fa_i("r-project")` file has been written: `tests/testthat.R`. It sets the testing environment
...
- Now we have to implement some unit tests. Let's create an `r fontawesome::fa_i("r-project")` script for testing the function `moyenne()`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;All tests files are stored in `tests/testthat/` and their names must start with `test-*`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Let's add some tests in `tests/testthat/test-moyenne.R`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;To run the test we will use `devtools::test()`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;We need to change the code of the function `moyenne()` to deal with `NA` values.
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Let's add an additional parameter to our function: `na_rm` with a default value (`FALSE`). If `x` contains `NA` values and `na_rm = FALSE`, then an error will be returned. Otherwise (`na_rm = TRUE`) `NA` values will be removed and the computation can be done.
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Complete tests file available [**here**](https://gist.github.com/ahasverus/7863a8ca598154af99a3fc490b649d31)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;**One note:** Let's talk about package dependencies
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Usually a package depends on functions of others packages. So we need to tell `r fontawesome::fa_i("r-project")` about that to ensure that 1) others packages are installed when your package is installed, and 2) that they are made available when your package is loaded<sup><b>*</b></sup>.

.footnote[
*****This is true for every package (except for the package `{base}`), even for packages `{utils}`, `{stats}` and `{graphics}` installed by default with `r fontawesome::fa_i("r-project")`.
]


--

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;It's the purpose of the `NAMESPACE`

--

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;As said before, the `NAMESPACE` is automatically updated when `devtools::document()` is called. So we need to list these dependencies in the **Roxygen2** header with:
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;So we need to import this function of the package `{stats}`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Note that the functions `any()`, `is.na()`, `sum()`, `length()` and `stop()` are in the package `{base}`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;The `NAMESPACE` controls what happens when our package is loaded but not when it's installed. This is the role of `DESCRIPTION` and we need to add dependencies to this file.
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**R Package - Chap8.1**](https://r-pkgs.org/description.html#dependencies) and [**R Package - Chap13.6**](https://r-pkgs.org/namespace.html#imports)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**R Package - Chap20**](https://r-pkgs.org/release.html)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Inform existing users of changes in each release of your package with the `NEWS.md`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Try to keep this file updated after each version incrementation
...
Here we opted for creating a local versioned `r fontawesome::fa_i("r-project")` project: this workflow is called [**GitHub last**](https://happygitwithr.com/existing-github-last.html).

--

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;So we need to:

1. Create an new empty repository on our GitHub account (or organization)
2. Add the remote (GitHub repository URL) to our local `r fontawesome::fa_i("git")` project
3. Push our versioned `r fontawesome::fa_i("r-project")` project to this new repository
...
- Directly from `r fontawesome::fa_i("r-project")` in one command line

---

## Connecting to GitHub - Option 1

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Log in on your GitHub account and create a new empty repository (click on the **+** on the top-right)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Give a name to the new repository and let other options to their defaults values (no README, no LICENSE, no .gitignore)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Choose your protocol with which you communicate with GitHub (HTTPS or SSH if you have generated SSH keys)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;To connect a local git project to a GitHub repository, run the following command line under the RStudio terminal<sup>*****</sup>:

```sh
git remote add origin git@github.com:ahasverus/rpkg.git
```

or, if you prefer directly on the `r fontawesome::fa_i("r-project")` console:
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;So we need to rename our local 'master' branch in 'main'
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Before pushing our local project we will add two lines in the `DESCRIPTION` file:
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;**BUT** first we need to get a [**GitHub Personal Access Token**](https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/creating-a-personal-access-token) (PAT) which will allow `r fontawesome::fa_i("r-project")` to control GitHub (only once)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Make sure to replace `999999zzz...` by your token and make sure `.Renviron` ends with a newline!
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**Managing secrets**](https://cran.r-project.org/web/packages/httr/vignettes/secrets.html)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;This function will also try to push project but it will fail. We need to run:
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;It's time to add a **README** to our repository: in a glance user will know more about our project (what it does, how to install it, and how to use it).
...
We are creating a `.Rmd` because our project is an `r fontawesome::fa_i("r-project")` package. After editing the file we'll need to compile it into a `.md` file.
...
Two files have been created. The `.md` will be used by GitHub and the CRAN, but the `.html` will not be used by `r fontawesome::fa_i("r-project")` during the build of our package.
...
`r fontawesome::fa_i("exclamation-triangle", class = "dark")` &nbsp;Each time you edit the `README.Rmd` you will have to update the `.md` with `rmarkdown::render("README.Rmd")`
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;This is where ![:scale 3%](assets/img/actions-logo.png) `GitHub Actions`
...
deploy our `r fontawesome::fa_i("r-project")` package after each interaction with GitHub.

.center[![:scale 100%](assets/img/actions-workflow.png)]

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**Official website**](https://github.com/features/actions)

---

## GH Actions - Checks & Tests

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Instead of locally (and each time we make changes) checking our `r fontawesome::fa_i("r-project")` package with `devtools::check()` and running
...
- `release`: this will build our package on macOS with the latest release of `r fontawesome::fa_i("r-project")`;
- `standard`: this will build our package on three OS (linux, macOS and Windows) and the release and devel version of `r fontawesome::fa_i("r-project")`;
- `full`: this will build our package on the same three OS and multiple versions of `r fontawesome::fa_i("r-project")`.

---

## GH Actions - Checks & Tests

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Let's check and test our package in a robust way (cross-platform and multiple versions of `r fontawesome::fa_i("r-project")`)
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Our `README.Rmd` has been modified: a badge has been added. So we need to re-knit it:
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Let's commit changes and push to our repository
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;After a few minutes our package has been cheked and tested by GitHub servers!

---

## GH Actions - Checks & Tests

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;And we've got a green badge. **Yeah!!!**
...
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Resources: [**GH Actions for R**](https://ropenscilabs.github.io/actions_sandbox)


`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;And the complete `_devhistory.R` for this package: [**here**](https://gist.github.com/ahasverus/1ba2280bad8726d810791c0cc893a8b4)
...
.pull-left[
`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;A website for your package

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add badges to your repository

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add a DOI with Zenodo

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Create a logo for you packages

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add Data to your package

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add a vignette (tutorial)

`r fontawesome::fa_i("hand-point-right", class = "dark")` &nbsp;Add a code coverage
]
