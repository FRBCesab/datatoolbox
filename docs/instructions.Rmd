...
en le téléchargeant à cette adresse : <br /> [https://github.com/jgm/pandoc/releases/tag/2.16.1](https://github.com/jgm/pandoc/releases/tag/2.16.1)
...
Si vous souhaitez convertir des documents `markdown` en `pdf`, vous aurez besoin
...
### `r fontawesome::fa_i("github")`&nbsp;GitHub
