#' Update Xaringan CSS Theme
#'
#' This function updates the Xaringan CSS Theme of a particular talk.
#'
#' @param output the CSS filename (please use `here::here()`)
#'
#' @export
#'
#' @importFrom here here
#' @importFrom xaringanthemer write_xaringan_theme google_font
#'
#' @examples
#' \dontrun{
#' create_xaringan_theme()
#' create_xaringan_theme(
#'   here::here("courses","docker", "assets", "css", "xaringan-themer.css")
#' )
#' }


create_xaringan_theme <- function(
  output = here::here("assets", "css", "xaringan-themer.css")) {
  ...
  xaringanthemer::write_xaringan_theme(
    ...
    code_font_google                = xaringanthemer::google_font("Ubuntu Mono"),
