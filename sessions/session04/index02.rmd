...
[![Watch the video](assets/mp4/dplyr_join.mp4)](dplyr_join.mp4)
...
* **pivot_longer()** and **pivot_wider()** from package `tidyr` to reshape tibbles; see [here](https://www.fromthebottomoftheheap.net/2019/10/25/pivoting-tidily/) for example
