...
```{r echo=TRUE, eval=FALSE}
## Ouverture du csv
(prefectures <- readr::read_csv("~/Desktop/occitanie_prefectures.csv"))
```
...
```{r "map8", echo=FALSE, eval=TRUE, fig.align="center", fig.width=8, dpi=300, fig.height=7, out.width="70%", fig.path="assets/chunks/", warning=FALSE}
ggplot(data = occitanie) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  xlab("Longitude") + ylab("Latitude") + ggtitle("OCCITANIE") +
  geom_sf(data = prefectures, colour = "#3f3f3f") +
  ggsflabel::geom_sf_label_repel(aes(label = paste0(NAME_2, " (", CC_2, ")")))
```
