...
- objectif : creer le package pkgmin avec une fonction.
...
Commençons par créer l'arborescence du package nommé `{pkgmin}`

--

```{r echo=TRUE, eval=FALSE}
path <- "/Users/nicolascasajus/Desktop/pkgmin"
...
Contenu du fichier `man/pkgmin-package.Rd`
...
```{r echo=TRUE, eval=FALSE}
pkgmin::moyenne(c(2, 4, NA), na_rm = TRUE)
```
